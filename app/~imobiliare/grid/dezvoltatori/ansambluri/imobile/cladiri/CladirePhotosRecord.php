...
class CladirePhotosRecord extends \Imobiliare\GridsRecord
{
    ...
    public function __construct($id)
    {
        ...
        $this->view           = 'dezvoltatori.ansambluri.imobile.cladire.photos._index';
        $this->icon           = 'admin/img/icons/dt/gali.png';
        $this->caption        = 'Imagini';
        $this->toolbar        = 'dezvoltatori.ansambluri.imobile.cladire.photos.toolbar';
        $this->name           = 'dt';
        $this->display_start  = 0;
        $this->display_length = 10;
        $this->default_order  = "1,'asc'";
        $this->form           = 'Imobiliare\Nomenclatoare\Form\CladirePhotos';
        ...
        $this->row_source     = 'cladire_photo-row-source';
        ...
        $this->columns        = [
            ...
            '2' => [
                ...
                'type'      => 'view',
                'source'    => 'dezvoltatori.ansambluri.imobile.cladire.photos.~file_name',
            ],
            '3' => [
                'id'        => 'created_at',
                'orderable' => 'yes',
            ...
            '5' => [
                ...
                'type'      => 'view',
                'source'    => 'dezvoltatori.ansambluri.imobile.cladire.photos.~file_type',
            ],
            '6' => [
                'id'        => 'action',
                'orderable' => 'no',
                ...
                'type'      => 'view',
                'source'    => 'dezvoltatori.ansambluri.imobile.cladire.photos.~actions',
            ],
        ];
        $this->fields = [
            'fields'      => '',
    ...
    {
        return self::$instance = new CladirePhotosRecord('cladire_photo');
    }
