...
class ApartamentCladirePhotosRecord extends \Imobiliare\GridsRecord
{
    ...
    public function __construct($id)
    {
        ...
        $this->view           = 'dezvoltatori.ansambluri.imobile.cladire.apartament.photos._index';
        $this->icon           = 'admin/img/icons/dt/gali.png';
        $this->caption        = 'Imagini';
        $this->toolbar        = 'dezvoltatori.ansambluri.imobile.cladire.apartament.photos.toolbar';
        $this->name           = 'dt';
        $this->display_start  = 0;
        $this->display_length = 10;
        $this->default_order  = "1,'asc'";
        $this->form           = 'Imobiliare\Nomenclatoare\Form\ApartamentCladirePhotos';
        ...
        $this->row_source     = 'apartament_cladire_photo-row-source';
        ...
        $this->columns        = [
            ...
            '2' => [
                ...
                'type'      => 'view',
                'source'    => 'dezvoltatori.ansambluri.imobile.cladire.apartament.photos.~file_name',
            ],
            '3' => [
                'id'        => 'created_at',
                'orderable' => 'yes',
            ...
            '5' => [
                ...
                'type'      => 'view',
                'source'    => 'dezvoltatori.ansambluri.imobile.cladire.apartament.photos.~file_type',
            ],
            '6' => [
                'id'        => 'action',
                'orderable' => 'no',
                ...
                'type'      => 'view',
                'source'    => 'dezvoltatori.ansambluri.imobile.cladire.apartament.photos.~actions',
            ],
        ];
        $this->fields = [
            'fields'      => '',
    ...
    {
        return self::$instance = new ApartamentCladirePhotosRecord('apartament_cladire_photo');
    }
