...
class Actions 
{
	...
	public function upload( $file, $config )
	{
		...
		try
		{
			...
			$upload_path = str_replace('{{id_gal}}', $this->data['gal_id'], $upload_path); 
			...
			$file_name = str_replace('{{id_gal}}', $this->data['gal_id'], $file_name);
			...
			call_user_func( [$this->model, 'createRecord'], $this->data + [
				'file'      => $file_name, 
				'path'      => $upload_path, 
