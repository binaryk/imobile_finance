...
@section('actions-items')
	<li class="action-update-record" data-id="{{$record->id}}"><a href="{{ URL::route('ansamblu_imobil', ['id' => 'ansamblu_imobile', 'id_ansamblu' => $record->id]) }}"><i class="fa fa-edit"></i> <span>Imobilele ansamblului {{ $record->nume  }}</span></a></li>
    <li class="divider"></li>
